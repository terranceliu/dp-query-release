...
from algorithms.ep import EntropyProjection
...
args = get_args(base='approx', iterative='pep')
...
pep = EntropyProjection(G, args.T, default_dir=model_save_dir, verbose=args.verbose, seed=args.test_seed)
